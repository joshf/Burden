...
while($row = mysql_fetch_assoc($getidinfo)) {
    ...
    echo "<div class=\"control-group\"><label class=\"control-label\" for=\"due\">Due</label><div class=\"controls\"><input type=\"text\" id=\"due\" name=\"due\" value=\"" . $row["due"] . "\" placeholder=\"Type a due date...\" pattern=\"None|((((0?[1-9]|[12]\d|3[01])[\.\-\/](0?[13578]|1[02])[\.\-\/]((1[6-9]|[2-9]\d)?\d{2}))|((0?[1-9]|[12]\d|30)[\.\-\/](0?[13456789]|1[012])[\.\-\/]((1[6-9]|[2-9]\d)?\d{2}))|((0?[1-9]|1\d|2[0-8])[\.\-\/]0?2[\.\-\/]((1[6-9]|[2-9]\d)?\d{2}))|(29[\.\-\/]0?2[\.\-\/]((1[6-9]|[2-9]\d)?(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00)|00)))|(((0[1-9]|[12]\d|3[01])(0[13578]|1[02])((1[6-9]|[2-9]\d)?\d{2}))|((0[1-9]|[12]\d|30)(0[13456789]|1[012])((1[6-9]|[2-9]\d)?\d{2}))|((0[1-9]|1\d|2[0-8])02((1[6-9]|[2-9]\d)?\d{2}))|(2902((1[6-9]|[2-9]\d)?(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00)|00))))\" data-validation-pattern-message=\"Please enter a valid date. Use DD-MM-YYYY.\"></div></div>";
...
echo "</select><span class=\"help-block\"><a id=\"addcategory\">Add new...</a></span></div></div><div class=\"control-group\"><div class=\"controls\"><label class=\"checkbox\">";
    
//Check if task is important
$checkifimportant = mysql_query("SELECT important FROM Data WHERE id = \"$idtoedit\"");
$checkifimportantresult = mysql_fetch_assoc($checkifimportant); 
if ($checkifimportantresult["important"] == "1") { 
    echo "<input type=\"checkbox\" id=\"importantstate\" name=\"importantstate\" checked=\"checked\"> Important?";
} else {
    echo "<input type=\"checkbox\" id=\"importantstate\" name=\"importantstate\"> Important?";
}
